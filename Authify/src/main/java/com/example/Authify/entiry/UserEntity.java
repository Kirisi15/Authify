package com.example.Authify.entiry;

import jakarta.persistence.*;
import org.hibernate.annotations.CreationTimestamp;
import org.hibernate.annotations.UpdateTimestamp;

import java.sql.Timestamp; // Use this instead of java.security.Timestamp
...
public class UserEntity {
    ...
    public UserEntity(Long id, String userId, String name, String email, String password,
                      ...
                      String resetOtp, Long resetOtpExpireAt, Timestamp createdAt, Timestamp updatedAt) {
        this.id = id;
        this.userId = userId;
        this.name = name;
        this.email = email;
